@if (auth()->check() &&
    ...
    <li class="nav-heading">TASK KRETECH</li>

    <li class="nav-item">
        <a class="nav-link {{ request()->segment(2) == 'tasking' ? '' : 'collapsed' }}"
            href="{{ route('kretech.tasking') }}">
        ...
        <ul id="components-nav"
            ...
            <li>
                <a href="{{ route('kretech.portfolio') }}"
                    class="{{ request()->segment(2) == 'portfolio' ? 'active' : '' }}">
                    <i class="bi bi-circle"></i><span>Portfolio</span>
                </a>
            </li>
            <li>
                <a href="{{ route('kretech.article') }}"
                    class="{{ request()->segment(2) == 'article' ? 'active' : '' }}">
