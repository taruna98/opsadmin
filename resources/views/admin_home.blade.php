        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    @elseif(auth()->check() &&
                            auth()->user()->hasRole(['kretech member']))
                        <!-- Kretech Card -->
                                ...
                                @foreach ($all_activity as $all_act)
                                    <div class="activity-item d-flex">
                                        <div class="activite-label">
                                            {{ str_replace('ago', '', \Carbon\Carbon::parse($all_act->created_at)->diffForHumans()) }}
                                        </div>
                                        <i
                                            class='bi bi-circle-fill activity-badge text-{{ $all_act->module == 'Admin' ? 'primary' : 'danger' }} align-self-start'></i>
